...
class OutOfGraphLoggedPrioritizedReplayBuffer(
    ...
    def __init__(self, log_dir, *args, **kwargs):
        ...
        super(OutOfGraphLoggedPrioritizedReplayBuffer,
    ...
    def add(self, observation, action, reward, terminal, *args):
        super(OutOfGraphLoggedPrioritizedReplayBuffer,
              self).add(observation, action, reward, terminal, *args)
    ...
    def load(self, checkpoint_dir, suffix):
        super(OutOfGraphLoggedPrioritizedReplayBuffer,
              self).load(checkpoint_dir, suffix)
    ...
    def _log_buffer(self):
        ...
        for attr in checkpointable_elements:
            filename = self._generate_filename(self._log_dir, attr,
                                               self._log_count)
...
class WrappedLoggedPrioritizedReplayBuffer(
    ...
    def __init__(self,
        ...
        super(WrappedLoggedPrioritizedReplayBuffer,
    ...
    """
        return tf.py_func(self.memory.set_priority, [indices, priorities], [],
    ...
    Returns:
      priorities: tf.Tensor with dtype float and shape [n], the priorities at
        the indices.
    """
        return tf.py_func(self.memory.get_priority, [indices],
                          tf.float32,
