    ...
    for normalization in normalizations:
        ...
        for i in range(FLAGS.initial_seed, FLAGS.initial_seed + num_runs):
            ...
            with run:
                ...
                gin_bindings = [f"{agent_name}.seed={FLAGS.initial_seed}", f"{agent_name}.normalization = '{normalization}'"]
                ...
                LOG_PATH = os.path.join(f'{path}/{FLAGS.agent}/{FLAGS.env}_{normalization}_fixed_20', f'test{i}')
