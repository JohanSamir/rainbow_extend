...
class FixedReplayRunner(run_experiment.Runner):
    ...
    def __init__(self, base_dir, create_agent_fn, create_environment_fn, num_iterations, training_steps,
                 evaluation_steps):
    ...
    def _run_train_phase(self):
        ...
        tf.logging.info('Average training steps per second: %.2f', self._training_steps / time_delta)
    ...
    def _save_tensorboard_summaries(self, iteration, num_episodes_eval, average_reward_eval):
