...
initializers = {"xavier_uniform": nn.initializers.xavier_uniform(), 
                "variance_scaling_1": jax.nn.initializers.variance_scaling(scale=0.1,mode='fan_in',distribution='uniform'),
                "variance_scaling_2": jax.nn.initializers.variance_scaling(scale=0.3,mode='fan_in',distribution='uniform'),
                "variance_scaling_3": jax.nn.initializers.variance_scaling(scale=0.8,mode='fan_in',distribution='uniform'),
                "variance_scaling_4": jax.nn.initializers.variance_scaling(scale=1,mode='fan_in',distribution='uniform'),
                "variance_scaling_5": jax.nn.initializers.variance_scaling(scale=2,mode='fan_in',distribution='uniform'),
                "variance_scaling_6": jax.nn.initializers.variance_scaling(scale=10,mode='fan_in',distribution='uniform'),
