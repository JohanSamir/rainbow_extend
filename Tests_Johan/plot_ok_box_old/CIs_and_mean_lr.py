...
initializers = ['10','5','2', '1','0.1', '0.01','0.001','0.0001','0.00001']

name = 'johan'
#name_sub = 'ExperimentsInitializer'
#name_sub_sub='2_activation_experiments_Rainbow'

name_sub = 'ExperimentsInitializer/2_learning_rates_experiments_Rainbow/'
name_sub_sub='2_lr_experiments_Rainbow'
num_runs = 7
...
for env in environments:
  ...
  df = pd.DataFrame(total, columns = ['10','5','2', '1','0.1', '0.01','0.001','0.0001','0.00001'])
  df = df.astype({'10': float, '5': float,'2': float,
    '1': float,'0.1': float,'0.01': float,'0.001': float,
    '0.0001': float, '0.00001': float})
