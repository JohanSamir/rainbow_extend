...
initializers = [
    "zeros", "ones", "variance_baseline", "variance_0.1", "variance_0.3", "variance_0.8", "variance_3", "variance_5",
    "variance_10", "he_nor", "he_uni", "xavier_uni", "xavier_nor", "lecun_uni", "lecun_nor", "orthogonal"
]
